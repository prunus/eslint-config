...
const rules = {
   ...
   */
  ...override( 'lines-between-class-members', [ 'warn', { exceptAfterSingleLine: false, exceptAfterOverload: true } ] ),
   ...
   */
  ...override( 'no-empty-function', [ 'warn', {
   ...
   */
  ...override( 'no-extra-parens', [ 'error' ] ),
   ...
   */
  '@typescript-eslint/no-implicit-any-catch': [ 'warn', { allowExplicitAny: false } ],
   ...
   */
  ...override( 'no-unused-expressions', [ 'error', {
   ...
   */
  ...override( 'no-use-before-define', [ 'error', {
    enums: true,
    typedefs: true,
   ...
   */
  ...override( 'quotes', [ 'warn', 'single', { avoidEscape: true, allowTemplateLiterals: true } ] ),
   ...
   */
  ...override( 'semi', [ 'warn', 'never', { beforeStatementContinuationChars: 'always' } ] ),
